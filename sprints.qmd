...
- No required format, just whatever you think is best for communication. Some groups were able to just show and narrate when they had in RStudio or a Jupyter Notebook, others made slides (that don't need to be perfectly polishe).
...
Sprint retrospectives provide a mechanism for continually improving the working relationship among your team. 
